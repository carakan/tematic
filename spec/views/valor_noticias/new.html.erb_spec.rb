...
describe "/valor_noticias/new.html.erb" do
  include ValorNoticiasHelper
  
  before(:each) do
    @valor_noticia = mock_model(ValorNoticia)
    @valor_noticia.stub!(:new_record?).and_return(true)
  ...
  it "should render new form" do
    render "/valor_noticias/new.html.erb"
    
    response.should have_tag("form[action=?][method=post]", valor_noticias_path) do
